...
CREATE TABLE IF NOT EXISTS "public"."workflow_steps" (
    ...
    "webhook_custom_body" "text",
    "webhook_contact_fields" "jsonb" DEFAULT NULL,
    CONSTRAINT "workflow_steps_channel_check" CHECK (((("channel" = 'whatsapp'::"text") AND ("template_id" IS NOT NULL)) OR (("channel" = 'email'::"text") AND ("email_subject" IS NOT NULL) AND ("email_body" IS NOT NULL)) OR (("channel" = 'webhook'::"text") AND ("webhook_url" IS NOT NULL)))),
