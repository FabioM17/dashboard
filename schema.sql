...
CREATE TABLE IF NOT EXISTS "public"."workflow_steps" (
    ...
    "n8n_auth_header" "text",
    "n8n_custom_body" "text",
    "n8n_contact_fields" "jsonb" DEFAULT NULL,
    CONSTRAINT "workflow_steps_channel_check" CHECK (((("channel" = 'whatsapp'::"text") AND ("template_id" IS NOT NULL)) OR (("channel" = 'email'::"text") AND ("email_subject" IS NOT NULL) AND ("email_body" IS NOT NULL)) OR (("channel" = 'n8n'::"text") AND ("n8n_webhook_url" IS NOT NULL)))),
